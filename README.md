...
<p align="center">
 <img  height="470rem" alt="GIF" src="https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExejUxb2hsdGE3ZXZwNTNrMHZ6dml5enN2NXZqejEwYXJ2Y29oMDNkMCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/J26jakVWt8aPEUpyir/giphy.gif"/>
</p>
...
100% offline (HTML): filtra tu checklist de findings por Cliente, Servidor y Otras vulnerabilidades (Open Redirect, CORS, CSRF, XSS, SSRF, SQLi, XXE, WebSockets, CSP, cookies, proxy bypass, etc.), mostrando el header relacionado y un resumen táctico.<br><br>
,<a href="https://youtu.be/5ZGcOCpBxQY" target="_blank" rel="noopener">demo de la tool Youtube</a>.** 
<br><br> 

<p align="center">
 <img  height="420rem" alt="GIF" src="https://github.com/Aquiles369/iconos/blob/main/demo_cors_excalibur.gif"/>
</p>
...
### <picture> <img src = "https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExMTZ1MHJpOGZ2ZHo1eXdlYnhibXl3cDNqdWYweWxjNmc5aTFpZmRtZSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/c1H1pp0cSTX7lgsJTw/giphy.gif" width = 80px>  </picture> Características
<br><br>

- Categorías 


• Alta masiva (una vulnerabilidad por línea; opcional “Nombre: encabezado – resumen”).<br><br>



- Buscador global

• Panel superior/lat. con input que filtra por nombre, header y resumen.<br>

• Enter salta al primer resultado; scroll suave y resaltado del ítem.<br><br>
...
### <picture> <img src = "https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExaDh4anB5NHowbDdwMzc4aGNoMWYzZnA1ZDBmZzVtNGhoa2V1N3o1cyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/kBq8YBhg6bmPZ4sP4Y/giphy.gif" width = 80px>  </picture> Uso
<br><br>
...
3. Buscar por vulnerabilidad, header o resumen.

4. Exportar JSON para versionar/compartir; Importar JSON para cargar packs.
...
### <picture> <img src = "https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExc3YwbG9zbmU1amprdTJsbmxzYnpobzd5eGtnazB6b2FmdnllaTRhZyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/h8UlsEpqiCISTKUzvz/giphy.gif" width = 80px>  </picture> “Excalibur — tu mapa de vulnerabilidades y encabezados. Búscalo. Offline, al toque.”
<br>
